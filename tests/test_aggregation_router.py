...
from queryhub.es_query_coverter.aggregations.models import (
...
# Mock dependencies
fake_auth_dependency = types.ModuleType("queryhub.utils.auth_dependency")
fake_auth_dependency.get_current_client = lambda: None
sys.modules["queryhub.utils.auth_dependency"] = fake_auth_dependency

fake_client_service = types.ModuleType("queryhub.service.client_service")
...
sys.modules["queryhub.service.client_service"] = fake_client_service

fake_authorization = types.ModuleType("queryhub.utils.authorization")
fake_authorization.authorize = lambda *args, **kwargs: None
sys.modules["queryhub.utils.authorization"] = fake_authorization

# Import the router
aggregation_router = importlib.import_module("queryhub.routers.aggregation_router")
