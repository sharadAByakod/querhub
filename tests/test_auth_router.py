...
from queryhub.model.client_model import Client, TokenRequest
...
fake_security = types.ModuleType("queryhub.utils.security")
fake_security.ACCESS_TOKEN_EXPIRE = 30
fake_security.create_access_token = lambda *args, **kwargs: "token"
sys.modules["queryhub.utils.security"] = fake_security

auth_router = importlib.import_module("queryhub.routers.auth_router")
