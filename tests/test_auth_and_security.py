...
def _load_actual_security_module():
    return _load_module("security_actual", "src/queryhub/utils/security.py")


def _load_actual_client_service_module(monkeypatch):
    security_module = _load_actual_security_module()
    monkeypatch.setitem(sys.modules, "queryhub.utils.security", security_module)
    return _load_module("client_service_actual", "src/queryhub/service/client_service.py")


def _load_actual_authorization_module():
    return _load_module("authorization_actual", "src/queryhub/utils/authorization.py")
...
def _load_actual_auth_dependency_module(monkeypatch):
    ...
    monkeypatch.setitem(
        sys.modules,
        "queryhub.service.client_service",
        client_service_module,
    )
    return _load_module("auth_dependency_actual", "src/queryhub/utils/auth_dependency.py")
